...
import {View, StyleSheet,Text,Image, ScrollView, TextComponent,SafeAreaView, Alert} from 'react-native';
...
const Points = () => {
    ...
    useEffect(()=>{
        async function loadPosition(){
            ...
            if(status !== 'granted'){
                Alert.alert('ooopss..','precisamos da sua permissão para obter sua localização');
                return;
            }
              ...
              {initialPosition[0] !== 0 && (  <MapView 
                ...
                initialRegion={{
                    ...
                    {points.map(points =>(
                                  ...
                                  onPress={() => {handleNavigateToDetail(Number(points.id))}}
